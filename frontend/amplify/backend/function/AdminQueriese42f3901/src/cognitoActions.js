...
// adminCreateUser is a bit of a special case, as it requires a password. We can't use the AWS SDK for this, as it requires a confirmation code. So we use the AWS CLI.
